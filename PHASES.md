...
| Phase | 상태 | 예상 시간 | 비고 |
|-------|------|----------|------|
| -1. 베이스라인 | ☐ 대기 | ~30분 | Phase 4 비교 기준선 |
| 0a. 슬래시 모델 검증 | ☐ 대기 | ~20분 | **BLOCKER** |
| 0b. Codex CLI 명세 | ☐ 대기 | ~20분 | 0a 통과 후 |
| 0c. 환경 확인 | ☐ 대기 | ~20분 | timeout provider 필수 |
| 1. `/plan` 구현 | ☐ 대기 | ~1.5시간 | Phase 0 전부 통과 필수 |
| 2. `/work` 구현 | ☐ 대기 | ~1.5시간 | |
| 3. `/ship` 구현 | ☐ 대기 | ~1시간 | |
